...
describe('Testing login Book', () => {
    ...
    it("Should return User success for Login", async () => {
        ...
        const mockAuth = {
            "statusCode": 200,
            "status": "success",
            "token": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyIjoiamVmZmVyc29uQHRlc3RlLmNvbS5iciIsInBhc3N3b3JkIjoiMTIzNDU2IiwiaWF0IjoxNjc5ODA1MTEwLCJleHAiOjE2Nzk4OTE1MTB9.C59x6nPUULa4xH2JSmgu80ze_-YxCczP4GSmsAirX9s",
            "expiresIn": 86400,
            "type": "jwt"
        }
