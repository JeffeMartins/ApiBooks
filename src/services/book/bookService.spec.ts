    ...
    const request: any = [
      {
        ...
        author: 'J.K. Rowling',
        description:
          'O livro conta a história de Harry Potter, um jovem órfão que descobre aos 11 anos que é um bruxo.',
        publisher: 'Rocco',
  ...
  it('Should return success for rentedBookById', async () => {
    ...
    const mockResponse = {
      ...
      data: {
        ...
        author: 'John Green',
        description:
          'O livro narra a história de dois adolescentes que se conhecem em um grupo de apoio para pacientes com câncer.',
